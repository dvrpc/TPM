...
<h3 class="tpm-content-subheaders theme-font-color"></h3>
...
const ref = {
    'highway': {
        'measure': `
            <h2 class="tpm-content-section-header theme-font-color">What do We Measure?</h2>
        ...
        `,
        'targets': `
            <h2 class="tpm-content-section-header theme-font-color">What are the Targets?</h2>
            <h3 class="tpm-content-subheaders theme-font-color">New Jersey</h3>
            <div class="table-overflow-wrapper">
                <table>
                    <thead>
            ...
            <h3 class="tpm-content-subheaders theme-font-color">Pennsylvania</h3>
            <div class="table-overflow-wrapper">
                <table>
                    <thead>
                        <th class="table-cell-first">Measure</th>
        ...
        `,
        'how': `
            <h2 class="tpm-content-section-header theme-font-color">How are We Doing?</h2>
            ...
            <h3 class="tpm-content-subheaders theme-font-color">Meeting a Target:</h3>
            <span>If the actual outcome for a performance measure is equal to or less than the target, the target has been met.</span>
            <h3 class="tpm-content-subheaders theme-font-color">Better than Baseline</h3>
        ...
        `,
        'dates': `
            <h2 class="tpm-content-section-header theme-font-color">Key Dates & Resources</h2>
            <h3 class="tpm-content-subheaders theme-font-color">Key Dates</h3>
            <article id="dates-wrapper">
                <div class="dates-entry dates-entry-left">
                    <span class="dates-circle dates-circle-left"></span>
            ...
            <h3 class="tpm-content-subheaders theme-font-color">Resources</h3>
            <ul>
    ...
    'bridgepavement': {
        'measure': `
            <h2 class="tpm-content-section-header theme-font-color">What do We Measure?</h2>
            <h3 class="tpm-content-subheaders theme-font-color">Pavement</h3>
            ...
            <h3 class="tpm-content-subheaders theme-font-color">Bridges</h3>
        ...
        'targets': `
            <h2 class="tpm-content-section-header theme-font-color">What are the Targets?</h2>
            <h3 class="tpm-content-subheaders theme-font-color">New Jersey Interstate Pavement Infrastructure Targets</h3>
            <div class="table-overflow-wrapper">
                <table>
                    <thead>
                        <th class="table-cell-first">Measure</th>
            ...
            <h3 class="tpm-content-subheaders theme-font-color">New Jersey Non-Interstate NHS Pavement Infrastructure Targets</h3>
            <div class="table-overflow-wrapper">
                <table>
                    <thead>
                        <th class="table-cell-first">Measure</th>
            ...
            <h3 class="tpm-content-subheaders theme-font-color">Pennsylvania Interstate Pavement Infrastructure Targets</h3>
            <div class="table-overflow-wrapper">
                <table>
                    <thead>
                        <th class="table-cell-first">Measure</th>
            ...
            <h3 class="tpm-content-subheaders theme-font-color">Pennsylvania Non-Interstate NHS Pavement Infrastructure Targets</h3>
            <div class="table-overflow-wrapper">
                <table>
                    <thead>
                        <th class="table-cell-first">Measure</th>
            ...
            <h3 class="tpm-content-subheaders theme-font-color">New Jersey Bridge Infrastructure Targets</h3>
            <div class="table-overflow-wrapper">
                <table>
                    <thead>
                        <th class="table-cell-first">Measure</th>
            ...
            <h3 class="tpm-content-subheaders theme-font-color">Pennsylvania Bridge Infrastructure Targets</h3>
            <div class="table-overflow-wrapper">
                <table>
                    <thead>
                        <th class="table-cell-first">Measure</th>
    ...
    'systemperf': {
        'measure': `
            <h2 class="tpm-content-section-header theme-font-color">What do We Measure?</h2>
            <h3 class="tpm-content-subheaders theme-font-color">National Highway System (NHS) Travel Time Reliability</h3>
            ...
            <h3 class="tpm-content-subheaders theme-font-color">Freight Reliability</h3>
            ...
            <h3 class="tpm-content-subheaders theme-font-color">Performance of the CMAQ Program</h3>
            ...
            <h3 class="tpm-content-subheaders theme-font-color">Congestion Measures</h3>
            ...
            <h3 class="tpm-content-subheaders theme-font-color">Emissions Reduction Measures</h3>
    ...
    'ptasp': {
        'measure': `
            ...
            <h3 class="tpm-content-subheaders theme-font-color">Fatalities</h3>
            ...
            <h3 class="tpm-content-subheaders theme-font-color">Injuries</h3>
            ...
            <h3 class="tpm-content-subheaders theme-font-color">Safety Events</h3>
            ...
            <h3 class="tpm-content-subheaders theme-font-color">System Reliability</h3>
    ...
    'transitasset': {
        'measure': `
            ...
            <h3 class="tpm-content-subheaders theme-font-color">Rolling Stock</h3>
            ...
            <h3 class="tpm-content-subheaders theme-font-color">Equipment</h3>
            ...
            <h3 class="tpm-content-subheaders theme-font-color">Infrastructure</h3>
            ...
            <h3 class="tpm-content-subheaders theme-font-color">Facilities</h3>
